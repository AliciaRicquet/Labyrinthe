...
public class DemoIG19 {
	...
	public static void main(String[] args) {
		...
		Object parametres[];
		parametres=IG.saisirParametres(); // On ouvre la fenÃªtre de paramétrage pour la saisie
		
		// Création de la fenÃªtre de jeu et affichage de la fenÃªtre 
		int nbJoueurs=((Integer)parametres[0]).intValue(); // Récupération du nombre de joueurs
		IG.creerFenetreJeu("Démo Librairie IG version 1.9",nbJoueurs); // On crée la fenÃªtre
